...
function App() {
	...
	<div className={styles.app}>
	    ...
	    <p>
	    The AI Pathologies card deck is an introduction to understanding different ways
	that AIs can malfunction. It’s a teaching tool and a conversation starter for anyone
	working with or interested in AIs.</p>
	    <p className={styles.spacer}>Here’s the big idea: AIs can get sick.
	    When AIs become your knowledge workers, how can you know they’re performing as expected?
	    Draw a hand, <b>get a free report</b>, and find out more.</p>
	    </section>
